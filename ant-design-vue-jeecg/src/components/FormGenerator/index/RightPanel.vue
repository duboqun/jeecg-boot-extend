...
import TreeNodeDialog from '@/components/FormGenerator/index/TreeNodeDialog'
...
export default {
  ...
  methods: {
    ...
    getTableNameList() {
      const url = '/actBusiness/getTableNameList'
      const method = 'get'
      httpAction(url, null, method).then((res) => {
        if (res.success) {
